...
public interface IReservaTemporalRepository extends JpaRepository<ReservaTemporal, ReservaTemporalId>
{
	 ...
	 */
	@Query("SELECT th.tramoHorario, COUNT(*) FROM ReservaTemporal rt " + "JOIN rt.reservaTemporalId.tramoHorario th GROUP BY th.tramoHorario")
	 ...
	 */
	@Query("SELECT ds.diaSemana, COUNT(*) FROM ReservaTemporal rt " + "JOIN rt.reservaTemporalId.diaSemana ds GROUP BY ds.diaSemana")
